...
\subsection{Learning \texorpdfstring{\surrogate}{M}} % use \texorpdfstring because of error with hyperref making a TOC entry with special typeset characters
...
\subsection{Calculating \texorpdfstring{\xQ}{xQ}}
...
\subsubsection{Hellinger Metric \texorpdfstring{$\bm{H^2}$}{H^2}} \label{sec:hellinger}
...
\subsubsection{Difference in Expected Reward: \texorpdfstring{$\bm{\Delta \mu}$}{delta mu}}
...
\subsubsection{Global Scale: \texorpdfstring{$\bm{(r_H-r_L)}$}{rH-rL}}
