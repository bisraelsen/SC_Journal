...
\paragraph{\ref{itm:H3}---Average Task Time}
       % \begin{figure}[tb]
            ...
            % \label{fig:time_box}
       % \end{figure}
Analysis of variance of the influence of \xQ{} and \xO{} on the participant's average task time was performed. The main effects of \xQ{} \Frations{1}{251}{0.64}. The main effect of \xO{} \Frations{1}{251}{0.06} was not found to be significant. The interaction effect was also not found to be significant \Frations{1}{251}{0.53}.
