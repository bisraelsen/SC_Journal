...
\end{figure*}
       % \begin{figure}[tb]
            % \centering
            % \includegraphics[width=0.55\linewidth]{Figures/trust_box.png}
...
%This experiment was not well suited to studying changes in cognitive load; future work will examine this. %further understanding will have to wait for future investigation.
