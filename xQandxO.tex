...
\begin{figure}[tb]
    ...
    \caption{Inputs to \xQ{} ($x$ is `feature of interest' for \task or \solve \brett{$x$ can't be feature of interest for \solve{} because not all candidate sovers may share that feature}).}
    \label{fig:xQ_v2}
    \vspace{-0.5cm}
\end{figure}
